...
class Api::V1::Invoices::TransactionsControllerTest < ActionController::TestCase
  ...
  test "/api/v1/invoices/:id/transactions#index returns the transactions associated with that invoice" do
    ...
    item = Transaction.create(invoice_id: invoice.id, credit_card_number: "1", result: "success")
    item2 = Transaction.create(invoice_id: invoice.id, credit_card_number: "2", result: "success")
    item3 = Transaction.create(invoice_id: invoice.id, credit_card_number: "3", result: "success")
    item4 = Transaction.create(invoice_id: invoice.id, credit_card_number: "4", result: "success")
